...
| Compound sequence run by at least one finisher | 3 | 6 | **5** | -1 | regressed |
| Start compound = the majority's | 4 | 6 | **7** | 1 | improved |
| Stop count = the field's mode | 7 | 7 | **5** | -2 | regressed |
| Mean share of the field that ran the recommended sequence | 0.153 | 0.329 | **0.217** | -0.112 | regressed |
| Mean |first stop − field green-flag median| (laps, non-SC weekends) | 5.000 | 5.000 | **1.333** | -3.667 | improved |
| Mean signed first stop − field median (laps, non-SC weekends) | 5.000 | 5.000 | **0.000** | -5.000 | improved |
| Same, the tyre-optimal plan (no prior, no position term) | – | 3.333 | **3.000** | -0.333 | improved |
| Same, V3 with the first-stop prior switched off (kappa = 0) | – | 5.000 | **1.333** | -3.667 | improved |
| Share of the field's first stops inside the model's window | 0.230 | 0.303 | **0.530** | +0.227 | improved |
| Oracle regret of the tool's plan (s, true race rates, same cost structure) | 13.4 | 12.0 | **12.7** | +0.6 | regressed |
| Oracle regret of the field's modal plan (s) | 13.8 | 15.6 | **17.7** | +2.1 | regressed |
| Oracle regret of the winner's plan (s) | 16.5 | 18.9 | **20.2** | +1.2 | regressed |
...
| Share of cars whose own plan shares the field plan's shape | – | 0.795 | **0.735** | -0.060 | regressed |
| Per-car first-stop spread within a weekend (laps) | – | 8.857 | **6.571** | -2.286 | regressed |
...
| Live engine tick, whole field (ms, mean over the replays) | 1070.2 | 70.8 | **92.3** | +21.5 | regressed |
| Live engine tick, p95 (ms) | 1347.5 | 77.2 | **101.7** | +24.5 | regressed |
| Live engine tick, worst lap (ms) | 1408.6 | 128.6 | **208.7** | +80.1 | regressed |
| Share of real stops inside the engine's window 3 laps earlier | 0.362 | 0.442 | **0.459** | +0.017 | not meaningfully changed |
| Share of real stops within 3 laps of the recommendation | 0.399 | 0.533 | **0.545** | +0.012 | not meaningfully changed |
| Median |recommended in-lap − actual| (laps) | 3.750 | 2.500 | **2.500** | +0.000 | unchanged |
| 'Box now' cost the lap before the real stop (s, median) | 2.516 | 1.478 | **1.235** | -0.243 | improved |
| Live signal precision: window (a stop within 3 laps = true positive) | – | – | **0.174** | – | unavailable |
| Live signal recall: window | – | – | **0.558** | – | unavailable |
| Live signal precision: box_now (a stop within 3 laps = true positive) | – | – | **0.196** | – | unavailable |
| Live signal recall: box_now | – | – | **0.555** | – | unavailable |
...
| Prior-only outlook matching the field's modal sequence | 0 | 0 | **2** | 2 | improved |
| Same, with the plan prior read letter-for-letter (no C-number mapping) | – | 3 | **3** | 0 | unchanged |
| Prior-only outlook: mean share of the field on its plan | 0.329 | 0.262 | **0.217** | -0.045 | regressed |
| Production posterior fit (s) | 247.372 | 6.648 | **6.310** | -0.338 | improved |
| Weekend refit fit, 2x800x800 (s) | 21.297 | 3.580 | **2.906** | -0.674 | improved |
| Strategy search, 500 draws, 1-lap grid, full objective (s) | 0.636 | 0.680 | **1.000** | +0.320 | regressed |
| Peak resident memory of the speed benchmark (MB) | 1310.0 | 2090.0 | **2083.0** | -7.0 | not meaningfully changed |
| Whole benchmark suite, wall clock (s) | – | 1500.0 | **953.0** | -547.0 | improved |
| Tests passing | 20 | 27 | **156** | 129 | improved |
| Tests failing | 0 | 0 | **0** | 0 | unchanged |
| Tests skipped | 0 | 0 | **0** | 0 | unchanged |
| Gates failing across the benchmarked weekends | 22 | 7 | **5** | -2 | improved |
...
|---|---|---|---|---|---|---|---|---|---|---|
| Australia | 1-stop H-M @ 36 | 1-stop M-H @ 23 | **2-stop M-H-H @ 14,36** | 1-stop H-M @ 33 | MEDIUM-HARD (0.00→0.53→0.07) | MEDIUM-HARD | yes→yes→no | no→yes→yes | +8 / -2 / – / -11 (SC) | 11.1 / 9.4 / 28.3 / 20.3 / 25.6 |
| Japan | 1-stop S-H @ 21 | 1-stop M-H @ 23 | **1-stop M-H @ 19** | 1-stop H-S @ 33 | MEDIUM-HARD (0.00→0.85→0.85) | MEDIUM-HARD | yes→yes→yes | no→yes→yes | +15 / +5 / – / +1 (SC) | – / 0.6 / 0.6 / 0.4 / 0.5 |
| Barcelona | 2-stop M-H-H @ 19,43 | 2-stop S-M-S @ 21,43 | **3-stop M-S-M-S @ 12,30,47** | 3-stop M-M-S-S @ 16,32,49 | MEDIUM-HARD-HARD (0.46→0.00→0.00) | SOFT-HARD-MEDIUM-HARD | yes→yes→no | yes→no→yes | +3 / +8 / -1 / -1 | 5.6 / 6.9 / 3.7 / 11.3 / 9.1 |
| Austria | 2-stop M-H-H @ 23,47 | 2-stop M-H-M @ 22,46 | **2-stop M-H-M @ 20,43** | 3-stop S-S-M-M @ 18,36,54 | MEDIUM-HARD-HARD (0.29→0.24→0.24) | MEDIUM-HARD-HARD | yes→yes→yes | yes→yes→yes | +0 / +4 / +2 / +2 | 25.1 / 14.9 / 15.4 / 28.7 / 28.8 |
| Belgium | 1-stop S-M @ 24 | 1-stop M-S @ 20 | **1-stop M-S @ 16** | 1-stop S-M @ 23 | MEDIUM-HARD (0.00→0.05→0.05) | MEDIUM-SOFT | yes→yes→yes | no→yes→yes | +7 / +4 / – / +0 (SC) | 12.8 / 14.9 / 12.1 / 12.2 / 13.2 |
| Hungary | 2-stop M-H-M @ 23,47 | 2-stop M-H-H @ 22,46 | **2-stop M-H-M @ 18,43** | 2-stop M-M-S @ 25,51 | MEDIUM-HARD-HARD (0.00→0.32→0.00) | MEDIUM-HARD-HARD-SOFT | yes→yes→yes | yes→yes→yes | +6 / +3 / -1 / -1 | 21.6 / 34.0 / 23.9 / 36.7 / 32.6 |
| Italy | 1-stop M-H @ 23 | 1-stop M-H @ 25 | **1-stop M-H @ 21** | 1-stop H-M @ 28 | MEDIUM-HARD (0.32→0.32→0.32) | HARD-MEDIUM-MEDIUM | yes→yes→yes | yes→yes→yes | – / – / – / – (SC) | 4.0 / 3.5 / 4.7 / 14.5 / 31.7 |

### Live engine (archived replays)

| | HUN V1→V2→V3 | BCN V1→V2→V3 |
|---|---|---|
| Tick mean (ms) | 1156 → 73 → **96** | 985 → 68 → **88** |
| Tick p95 (ms) | 1375 → 81 → **105** | 1320 → 74 → **98** |
| Stops inside the window | 0.48 → 0.54 → **0.52** | 0.25 → 0.34 → **0.40** |
| Stops within 3 laps | 0.33 → 0.50 → **0.54** | 0.47 → 0.57 → **0.55** |
| Median stop error (laps) | 4.0 → 3.0 → **3.0** | 3.5 → 2.0 → **2.0** |
| Box-now cost 1 lap before (s) | 1.8 → 0.7 → **0.5** | 3.2 → 2.3 → **2.0** |
| Signal precision / recall (V3) | window 0.20/0.74, box_now 0.20/0.70, collapse 0.14/0.04 | window 0.15/0.38, box_now 0.20/0.42, collapse 0.20/0.06 |

### Leave-one-out calibration (V3)

| Held out | Grip budget S / M / H (s) | Manage cost, floor | Grid | Dirty air | λ | τ | κ |
|---|---|---|---|---|---|---|---|
| australia-2026 | 3.84 / 4.09 / 4.27 | 0.60, 0.45 | 0.00 | 0.067 | 0.450 | 6.00 | 0.00 |
| japan-2026 | 3.84 / 4.09 / 4.30 | 0.60, 0.45 | 0.00 | 0.137 | 0.450 | 4.00 | 0.00 |
| barcelona-2026 | 3.80 / 3.80 / 4.19 | 0.60, 0.45 | 0.00 | 0.067 | 0.100 | 2.50 | 0.00 |
| austria-2026 | 3.84 / 4.09 / 4.30 | 0.60, 0.45 | 0.00 | 0.084 | 0.450 | 4.00 | 0.00 |
| belgium-2026 | 3.84 / 4.09 / 4.27 | 0.60, 0.45 | 0.00 | 0.137 | 0.150 | 4.00 | 0.00 |
| hungary-2026 | 3.84 / 4.09 / 4.10 | 0.60, 0.45 | 0.00 | 0.067 | 0.150 | 4.00 | 0.00 |
| italy-2026 | 3.84 / 4.09 / 4.30 | 0.60, 0.45 | 0.00 | 0.137 | 0.000 | 6.00 | 0.00 |
| global | 3.84 / 4.09 / 4.30 | 0.60, 0.45 | 0.00 | 0.120 | 0.200 | 4.00 | 0.00 |
...
|---|---|---|---|---|---|---|
| full | 5/7 | 7/7 | 5/7 | 0.22 | 1.3 | 1.10 |
| no_race_state | 5/7 | 7/7 | 5/7 | 0.22 | 3.7 | 1.10 |
| symmetric_pack | 5/7 | 7/7 | 5/7 | 0.22 | 1.3 | 1.10 |
| rivals_no_history | 5/7 | 7/7 | 5/7 | 0.22 | 1.7 | 1.10 |
| place_value_task1 | 5/7 | 7/7 | 5/7 | 0.22 | 1.3 | 1.10 |
| hetero_pack | 5/7 | 7/7 | 5/7 | 0.22 | 1.7 | 1.10 |
| no_family_logit | 5/7 | 7/7 | 5/7 | 0.22 | 1.7 | 1.10 |
| rival_rate_levels_1 | 5/7 | 7/7 | 5/7 | 0.22 | 1.3 | 1.10 |
| extrap_off | 5/7 | 7/7 | 5/7 | 0.22 | 1.3 | 1.10 |
| race_state_no_cover | 5/7 | 7/7 | 5/7 | 0.22 | 1.3 | 1.10 |
| race_state_lead_lap_value | 5/7 | 7/7 | 5/7 | 0.22 | 1.3 | 1.10 |
| race_state_undiscounted | 4/7 | 6/7 | 5/7 | 0.18 | 3.0 | 1.10 |
| no_first_stop_prior | 5/7 | 7/7 | 5/7 | 0.22 | 1.3 | 1.10 |
| no_plan_prior | 2/7 | 2/7 | 5/7 | 0.05 | 2.0 | 1.10 |
| no_nomination_mapping | 5/7 | 6/7 | 6/7 | 0.28 | 1.0 | 1.10 |
| no_dirty_air_circuit | 5/7 | 7/7 | 5/7 | 0.22 | 1.3 | 1.10 |
| no_position | 5/7 | 7/7 | 5/7 | 0.22 | 1.0 | 1.10 |
| no_pace_cal | 7/7 | 7/7 | 6/7 | 0.34 | 0.7 | 1.10 |
| config_constants | 3/7 | 1/7 | 7/7 | 0.06 | 1.7 | 1.10 |
| practice_only | 4/7 | 7/7 | 6/7 | 0.16 | 1.0 | 1.04 |
| old_budget | 5/7 | 7/7 | 5/7 | 0.22 | 1.3 | 1.10 |
| no_cliff_budgets | 5/7 | 7/7 | 5/7 | 0.22 | 1.3 | 1.10 |
| no_circuit_regime_prior | 5/7 | 7/7 | 5/7 | 0.22 | 1.0 | 1.10 |
